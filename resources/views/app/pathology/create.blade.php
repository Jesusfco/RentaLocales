...
@section('title', 'Crear Patología')

@section('css')
@endsection

@section('content')
<h5><a href="{{ url('app/patologias') }}">Patologías </a> >> Crear patología</h5>
...
<form role="form" method="POST" enctype="multipart/form-data" onsubmit="return submitForm()">
    ...
    <input type="text" name="name" class="form-control" value="{{ old('name') }}"  placeholder="Nombre de Patología" required>
    </div>

    <div class="form-group">
      <label>Resumen</label>
      <input type="text" minlength="100" maxlength="190" name="resume" class="form-control" id="inputResume" value="{{ old('resume') }}" placeholder="Escribe brevemente en que consiste la Patología" required>
    ...
    <label>Redacta tu Patología</label>
    ...
    <br>
    <button type="submit" class="btn blue">Crear Nueva Patología</button>
  </form>
